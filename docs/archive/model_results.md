...
- [Feature importance results](../ceiling_study/feature_importance_results.md)
- [Evaluation protocol](../ceiling_study/eval_protocol.md)
...
Note: `data/archive/matching_validation/` contains matching-validation datasets (`label=match/no-match`) and is excluded from all open/closed results below.
...
Note: LR validation metrics for no-confidence variants were refreshed from current code on Feb 11, 2026 using `src/archive/models/logistic_regression.py --split val`.
