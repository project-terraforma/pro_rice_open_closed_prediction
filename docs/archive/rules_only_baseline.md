...
Current defaults in `src/archive/models/rules_only_baseline.py`:
- `open_threshold = 2.0`
...
Command: `python src/archive/models/rules_only_baseline.py --split val`  
...
**Test (test split)**  
Command: `python src/archive/models/rules_only_baseline.py --split test`  
...
**Validation (val split)**  
Command: `python src/archive/models/rules_only_baseline.py --split val` (with `use_source_conf=True`)  
...
**Test (test split)**  
Command: `python src/archive/models/rules_only_baseline.py --split test` (with `use_source_conf=True`)  
