...
- `artifacts/archive/hpo_weighted_pass1/bootstrap_confirm/bootstrap_confirm_metrics.csv`
- `artifacts/archive/hpo_weighted_pass1/bootstrap_confirm/bootstrap_selected_candidates.csv`
