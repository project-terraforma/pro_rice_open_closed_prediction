...
Current protocol now tracks dual gates (production + diagnostic); see `docs/ceiling_study/eval_protocol.md`.
...
- `artifacts/archive/hpo/lr_hpo/hpo_confirm_metrics.csv`
- `artifacts/archive/hpo/lightgbm_hpo/hpo_confirm_metrics.csv`
- `artifacts/archive/hpo/rf_hpo/hpo_confirm_metrics.csv`
- `artifacts/archive/hpo/xgboost_hpo/hpo_confirm_metrics.csv`
...
- `artifacts/archive/hpo/*_hpo/hpo_search_trials.csv` (`params_json`)
...
- `artifacts/archive/hpo_weighted_pass1/hpo_search_trials.csv`
- `artifacts/archive/hpo_weighted_pass1/hpo_selected_trials.csv`
- `artifacts/archive/hpo_weighted_pass1/hpo_confirm_metrics.csv`
- `artifacts/archive/hpo_weighted_pass1/hpo_run_config.json`
...
Implementation note:
- Narrow-pass design and rationale are documented in `docs/ceiling_study/hpo_optuna_narrow_design.md`.
