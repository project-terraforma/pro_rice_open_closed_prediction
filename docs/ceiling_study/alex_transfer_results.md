...
- `data/alex_assets/sf_places_raw.parquet`
- `data/alex_assets/sf_places_labeled_checkpoint.parquet`
- `data/alex_assets/nyc_places_raw.parquet`
- `data/alex_assets/nyc_places_labeled_checkpoint.parquet`
