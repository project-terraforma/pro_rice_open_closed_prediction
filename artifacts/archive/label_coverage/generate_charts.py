...
# Load results
history = pd.read_csv('/Users/claricepark/Desktop/pro_rice_open_closed_prediction/artifacts/archive/label_coverage/simulation_history.csv')
...
# Save figure
plt.tight_layout()
plt.savefig('/Users/claricepark/Desktop/pro_rice_open_closed_prediction/artifacts/archive/label_coverage/simulation_charts.png', dpi=300, bbox_inches='tight')
